...
class CMUCACSController extends Controller {
    ...
    public function indexAction() {
		...
		//PUMA = theme1
        $liste_QuestionFAQRepository = $QuestionFAQRepository->getQuestionsFAQ('2');
		//die();
		
        return $this->render('@App/AccesDroitsFAQ/cmucacs.html.twig',array('Liste_FAQ'=>$liste_QuestionFAQRepository));
