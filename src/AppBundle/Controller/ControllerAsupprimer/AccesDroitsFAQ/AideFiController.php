...
class AideFiController extends Controller {
    ...
    public function indexAction() {
		...
		//PUMA = theme1
        $liste_QuestionFAQRepository = $QuestionFAQRepository->getQuestionsFAQ('5');
		//die();
		
        return $this->render('@App/AccesDroitsFAQ/aidefi.html.twig',array('Liste_FAQ'=>$liste_QuestionFAQRepository));
    }
}
