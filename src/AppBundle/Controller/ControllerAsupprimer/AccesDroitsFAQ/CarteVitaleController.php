...
class CarteVitaleController extends Controller {
    ...
    public function indexAction() {
		...
		//PUMA = theme1
        $liste_QuestionFAQRepository = $QuestionFAQRepository->getQuestionsFAQ('7');
		//die();
		
        return $this->render('@App/AccesDroitsFAQ/cartevitale.html.twig',array('Liste_FAQ'=>$liste_QuestionFAQRepository));
    }
}
