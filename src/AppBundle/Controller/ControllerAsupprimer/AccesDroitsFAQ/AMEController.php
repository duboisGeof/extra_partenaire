...
class AMEController extends Controller {
    ...
    public function indexAction() {
		...
		//PUMA = theme1
        $liste_QuestionFAQRepository = $QuestionFAQRepository->getQuestionsFAQ('3');
		//die();
		
        return $this->render('@App/AccesDroitsFAQ/ame.html.twig',array('Liste_FAQ'=>$liste_QuestionFAQRepository));
    }
}
