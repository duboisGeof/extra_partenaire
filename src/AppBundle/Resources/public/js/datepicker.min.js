! function(t, e) {
    ...
    var n, r = (n = {
        ...
        h = function(e, a) {
            this._process_options(a), this.dates = new r, this.viewDate = this.o.defaultViewDate, this.focusDate = null, this.element = t(e), this.isInline = !1, this.isInput = this.element.is("input"), this.component = !!this.element.hasClass("date") && this.element.find(".add-on, .input-group-addon, .btn"), this.hasInput = this.component && this.element.find("input").length, this.component && 0 === this.component.length && (this.component = !1), this.picker = t(f.template), this._buildEvents(), this._attachEvents(), this.isInline ? this.picker.addClass("datepicker-inline").appendTo(this.element) : this.picker.addClass("datepicker-dropdown dropdown-menu"), this.o.rtl && this.picker.addClass("datepicker-rtl"), this.viewMode = this.o.startView, this.o.calendarWeeks && this.picker.find("tfoot .today, tfoot .clear").attr("colspan", function(t, e) {
                return parseInt(e) + 1
    ...
    h.prototype = {
        ...
        _process_options: function(s) {
            ...
            var n = this.o = t.extend({}, this._o),
                r = n.language;
            switch (p[r] || (r = r.split("-")[0], p[r] || (r = c.language)), n.language = r, n.startView) {
                case 2:
                case "decade":
                    n.startView = 2;
                    break;
            ...
            if (n.startDate !== -1 / 0 && (n.startDate ? n.startDate instanceof Date ? n.startDate = this._local_to_utc(this._zero_time(n.startDate)) : n.startDate = f.parseDate(n.startDate, h, n.language) : n.startDate = -1 / 0), n.endDate !== 1 / 0 && (n.endDate ? n.endDate instanceof Date ? n.endDate = this._local_to_utc(this._zero_time(n.endDate)) : n.endDate = f.parseDate(n.endDate, h, n.language) : n.endDate = 1 / 0), n.daysOfWeekDisabled = n.daysOfWeekDisabled || [], t.isArray(n.daysOfWeekDisabled) || (n.daysOfWeekDisabled = n.daysOfWeekDisabled.split(/[,\s]*/)), n.daysOfWeekDisabled = t.map(n.daysOfWeekDisabled, function(t) {
                ...
                var o = [];
                o.push(f.parseDate(n.datesDisabled, h, n.language)), n.datesDisabled = o
            }
            n.datesDisabled = t.map(n.datesDisabled, function(t) {
                return f.parseDate(t, h, n.language)
            });
        ...
        _trigger: function(e, a) {
            ...
            this.element.trigger({
                ...
                format: t.proxy(function(t, e) {
                    ...
                    return f.formatDate(a, e, this.o.language)
                }, this)
            })
        },
        show: function() {
        ...
        place: function() {
            ...
            var o = Math.max.apply(Math, h) + 10,
            ...
            if ("auto" === D && (f = -n + p - a, g = n + s - (p + d + a), D = Math.max(f, g) === g ? "top" : "bottom"), this.picker.addClass("datepicker-orient-" + D), "top" === D ? p += d : p -= a + parseInt(this.picker.css("padding-top")), this.o.rtl) {
                var v = i - (u + c);
                this.picker.css({
                    top: p,
                    right: v,
        ...
        update: function() {
            ...
            }, this)), i = !0) : (a = (a = this.isInput ? this.element.val() : this.element.data("date") || this.element.find("input").val()) && this.o.multidate ? a.split(this.o.multidateSeparator) : [a], delete this.element.data().date), a = t.map(a, t.proxy(function(t) {
        ...
        getClassNames: function(e) {
            var a = [],
                ...
                n = new Date;
            return e.getUTCFullYear() < i || e.getUTCFullYear() === i && e.getUTCMonth() < s ? a.push("old") : (e.getUTCFullYear() > i || e.getUTCFullYear() === i && e.getUTCMonth() > s) && a.push("new"), this.focusDate && e.valueOf() === this.focusDate.valueOf() && a.push("focused"), this.o.todayHighlight && e.getUTCFullYear() === n.getFullYear() && e.getUTCMonth() === n.getMonth() && e.getUTCDate() === n.getDate() && a.push("today"), -1 !== this.dates.contains(e) && a.push("active"), (e.valueOf() < this.o.startDate || e.valueOf() > this.o.endDate || -1 !== t.inArray(e.getUTCDay(), this.o.daysOfWeekDisabled)) && a.push("disabled"), this.o.datesDisabled.length > 0 && t.grep(this.o.datesDisabled, function(t) {
                return i = t, (a = e).getUTCFullYear() === i.getUTCFullYear() && a.getUTCMonth() === i.getUTCMonth() && a.getUTCDate() === i.getUTCDate();
                var a, i
        ...
        fill: function() {
            ...
            if (!isNaN(n) && !isNaN(r)) {
                this.picker.find(".datepicker-days thead .datepicker-switch").text(p[this.o.language].months[r] + " " + n), this.picker.find("tfoot .today").text(c).toggle(!1 !== this.o.todayBtn), this.picker.find("tfoot .clear").text(u).toggle(!1 !== this.o.clearBtn), this.updateNavArrows(), this.fillMonths();
                var g = a(n, r - 1, 28),
                    D = f.getDaysInMonth(g.getUTCFullYear(), g.getUTCMonth());
                g.setUTCDate(D), g.setUTCDate(D - (g.getUTCDay() - this.o.weekStart + 7) % 7);
                var v = new Date(g);
                v.setUTCDate(v.getUTCDate() + 42), v = v.valueOf();
                for (var m, y = []; g.valueOf() < v;) {
                    if (g.getUTCDay() === this.o.weekStart && (y.push("<tr>"), this.o.calendarWeeks)) {
                    ...
                    if ((m = this.getClassNames(g)).push("day"), this.o.beforeShowDay !== t.noop) {
                        var b = this.o.beforeShowDay(this._utc_to_local(g));
                        b === e ? b = {} : "boolean" == typeof b ? b = {
                            enabled: b
                        } : "string" == typeof b && (b = {
                            classes: b
                        }), !1 === b.enabled && m.push("disabled"), b.classes && (m = m.concat(b.classes.split(/\s+/))), b.tooltip && (i = b.tooltip)
                    }
                    m = t.unique(m), y.push('<td class="' + m.join(" ") + '"' + (i ? ' title="' + i + '"' : "") + ">" + g.getUTCDate() + "</td>"), i = null, g.getUTCDay() === this.o.weekEnd && y.push("</tr>"), g.setUTCDate(g.getUTCDate() + 1)
                }
                ...
                if (t.each(this.dates, function(t, e) {
                    ...
                    t.each(_, function(e, a) {
                        if (!t(a).hasClass("disabled")) {
                            ...
                            !1 === U.o.beforeShowMonth(i) && t(a).addClass("disabled")
                        }
                    })
                }
        ...
        _setDate: function(t, e) {
            var a;
            e && "date" !== e || this._toggle_multidate(t && new Date(t)), e && "view" !== e || (this.viewDate = t && new Date(t)), this.fill(), this.setValue(), e && "view" === e || this._trigger("changeDate"), this.isInput ? a = this.element : this.component && (a = this.element.find("input")), a && a.change(), !this.o.autoclose || e && "date" !== e || this.hide()
        },
            ...
            if (this.picker.is(":visible")) {
                ...
                switch (t.keyCode) {
                    ...
                    case 39:
                        ...
                        e = 37 === t.keyCode ? -1 : 1, t.ctrlKey ? (a = this.moveYear(this.dates.get(-1) || i(), e), s = this.moveYear(h, e), this._trigger("changeYear", this.viewDate)) : t.shiftKey ? (a = this.moveMonth(this.dates.get(-1) || i(), e), s = this.moveMonth(h, e), this._trigger("changeMonth", this.viewDate)) : ((a = new Date(this.dates.get(-1) || i())).setUTCDate(a.getUTCDate() + e), (s = new Date(h)).setUTCDate(h.getUTCDate() + e)), this.dateWithinRange(s) && (this.focusDate = this.viewDate = s, this.setValue(), this.fill(), t.preventDefault());
                        break;
                    case 38:
                    case 40:
                        if (!this.o.keyboardNavigation) break;
                        e = 38 === t.keyCode ? -1 : 1, t.ctrlKey ? (a = this.moveYear(this.dates.get(-1) || i(), e), s = this.moveYear(h, e), this._trigger("changeYear", this.viewDate)) : t.shiftKey ? (a = this.moveMonth(this.dates.get(-1) || i(), e), s = this.moveMonth(h, e), this._trigger("changeMonth", this.viewDate)) : ((a = new Date(this.dates.get(-1) || i())).setUTCDate(a.getUTCDate() + 7 * e), (s = new Date(h)).setUTCDate(h.getUTCDate() + 7 * e)), this.dateWithinRange(s) && (this.focusDate = this.viewDate = s, this.setValue(), this.fill(), t.preventDefault());
                        break;
                    case 32:
                        break;
                    case 13:
                        h = this.focusDate || this.dates.get(-1) || this.viewDate, this.o.keyboardNavigation && (this._toggle_multidate(h), r = !0), this.focusDate = null, this.viewDate = this.dates.get(-1) || this.viewDate, this.setValue(), this.fill(), this.picker.is(":visible") && (t.preventDefault(), "function" == typeof t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0, this.o.autoclose && this.hide());
                        break;
                    case 9:
        ...
        showMode: function(t) {
            t && (this.viewMode = Math.max(this.o.minViewMode, Math.min(2, this.viewMode + t))), this.picker.children("div").hide().filter(".datepicker-" + f.modes[this.viewMode].clsName).css("display", "block"), this.updateNavArrows()
        }
    };
    var o = function(e, a) {
        this.element = t(e), this.inputs = t.map(a.inputs, function(t) {
            return t.jquery ? t[0] : t
        }), delete a.inputs, d.call(t(this.inputs), a).bind("changeDate", t.proxy(this.dateUpdated, this)), this.pickers = t.map(this.inputs, function(e) {
    ...
    o.prototype = {
        ...
        dateUpdated: function(e) {
            if (!this.updating) {
                this.updating = !0;
                var a = t(e.target).data("datepicker").getUTCDate(),
                ...
                if (-1 !== i) {
                    if (t.each(this.pickers, function(t, e) {
                        ...
                        for (; r > n && a > this.dates[n];) this.pickers[n++].setUTCDate(a);
            ...
            return s.shift(), this.each(function() {
                ...
                if (!r) {
                    var d = function(e, a) {
                        ...
                        }(t.extend({}, c, d, l).language),
                        g = t.extend({}, c, f, d, l);
                    if (n.hasClass("input-daterange") || g.inputs) {
                        var D = {
                            inputs: g.inputs || n.find("input").toArray()
                        };
                        n.data("datepicker", r = new o(this, t.extend(g, D)))
                    } else n.data("datepicker", r = new h(this, g))
                }
                return ("string" != typeof a || "function" != typeof r[a] || (i = r[a].apply(r, s)) === e) && void 0
            }), i !== e ? i : this
        };
    t.fn.datepicker = d;
        ...
        f = {
            ...
            parseDate: function(i, s, n) {
                ...
                if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(i)) {
                    for (i = new Date, d = 0; d < u.length; d++) switch (o = c.exec(u[d]), l = parseInt(o[1]), o[2]) {
                        case "d":
                ...
                if (u.length !== w.length && (w = t(w).filter(function(e, a) {
                    ...
                    for (d = 0, k = w.length; k > d; d++) {
                        if (g = parseInt(u[d], 10), o = w[d], isNaN(g)) switch (o) {
                            case "MM":
                                D = t(p[n].months).filter(r), g = t.inArray(D[0], p[n].months) + 1;
                                break;
                            case "M":
                                D = t(p[n].monthsShort).filter(r), g = t.inArray(D[0], p[n].monthsShort) + 1
                        }
                        v[o] = g
                    }
    ...
    f.template = '<div class="datepicker"><div class="datepicker-days"><table class=" table-condensed">' + f.headTemplate + "<tbody></tbody>" + f.footTemplate + '</table></div><div class="datepicker-months"><table class="table-condensed">' + f.headTemplate + f.contTemplate + f.footTemplate + '</table></div><div class="datepicker-years"><table class="table-condensed">' + f.headTemplate + f.contTemplate + f.footTemplate + "</table></div></div>", t.fn.datepicker.DPGlobal = f, t.fn.datepicker.noConflict = function() {
        ...
        var a = t(this);
        a.data("datepicker") || (e.preventDefault(), d.call(a, "show"))
    }), t(function() {
