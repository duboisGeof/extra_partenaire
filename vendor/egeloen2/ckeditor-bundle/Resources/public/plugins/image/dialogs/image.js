                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                commit: function(a, b) {
                                    ...
                                    img_margin_left = b.getStyle('margin-left');
                                    img_margin_left = img_margin_left.slice(0,-2);
                                }
                            }, {
                                type: "text",
                                id: "txtVSpace",
                                ...
                                commit: function(a, b) {
                                    ...
                                    img_margin_top = b.getStyle("margin-top");
                                    img_margin_top = img_margin_top.slice(0,-2);
                                }
                            }, {
                                id: "cmbAlign",
                                ...
                                commit: function(a, b) {
                                    ...
                                    if (1 == a || 4 == a) {
                                        // G.DUBOIS
                                        // Ajout un attribut align sur l image pour que l image soit a coté du texte dans le mail
                                        // le float ne marche pas
                                        ...
                                        if (c ? b.setStyle("float", c) : b.removeStyle("float"), 1 == a) switch (c =
                                         ...
                                         b.setAttribute('align',"left");
                                         img_width = b.getStyle('width');
                                         img_width = img_width.slice(0,-2);

                                         img_height = b.getStyle('height');
                                         img_height = img_height.slice(0,-2);

                                         img_align = b.getStyle("float");




                                         console.log(b.getStyle('float'));
    ...
    /**CKEDITOR.on('dialogDefinition', function (ev) {
        ...
        if (dialogName == 'image') {
            dialogDefinition.onOk = function (e) {
                ...
                var imgHtml = CKEDITOR.dom.element.createFromHtml('<p><img align="'+ img_align +
                    '"height="'+ img_height +
                    '"width="'+ img_width + 
                    '"src="' + imageSrcUrl + 
                    '"hSpace="' + img_margin_left + 
                    '"vSpace="' + img_margin_top + 
