...
CKEDITOR.editorConfig = function( config ) {
	...
	// Activer le correcteur d'ortographe par defaut
	...
	config.removeButtons = 'About,Flash,Language,Superscript,Subscript,Preview,NewPage,Form,Checkbox,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,ShowBlocks,Save,NewPage';
